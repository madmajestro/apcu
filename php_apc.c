...
static PHP_INI_MH(OnUpdatePercentage)
{
...
STD_PHP_INI_ENTRY("apc.expunge_threshold", "0.5", PHP_INI_SYSTEM, OnUpdatePercentage,      expunge_threshold, zend_apcu_globals, apcu_globals)
#ifdef APC_MMAP
